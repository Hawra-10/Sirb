    ...
    <script>
        ...
        function toggleSkill(name) {
            ...
            if (existingTag) {
                ...
                if (lowerName.includes('coding') || lowerName.includes('programming')) colorClass = 'navy';
                else if (lowerName.includes('ui') || lowerName.includes('innovation')) colorClass = 'pink';
