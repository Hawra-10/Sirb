...
<body class="ar-body-setup">
  ...
  <div class="arS-container">
    ...
    <div class="ar-field">
      ...
      <div class="ar-name-row">
        <div class="ar-name-col">
          <input id="ar-firstname-input" class="ar-input" type="text" placeholder="First name" autocomplete="off" />
          <div class="ar-error" id="ar-firstname-error">First name is required.</div>
        </div>
        <div class="ar-name-col">
          <input id="ar-lastname-input" class="ar-input" type="text" placeholder="Last name" autocomplete="off" />
    ...
    <div class="ar-field">
      ...
      <div class="ar-radio-group" id="ar-major-group">
        <label class="ar-radio-option">
          <input type="radio" name="ar-major" value="Computer Science" />
          <span class="ar-radio-label">Computer Science</span>
        </label>
        <label class="ar-radio-option">
          <input type="radio" name="ar-major" value="Information Technology" />
          <span class="ar-radio-label">Information Technology</span>
        </label>
        <label class="ar-radio-option">
          <input type="radio" name="ar-major" value="Information Systems" />
          <span class="ar-radio-label">Information Systems</span>
        </label>
        <label class="ar-radio-option">
          <input type="radio" name="ar-major" value="Software Engineering" />
    ...
    <!-- Done button -->
    <button class="ar-button" id="ar-done-btn">Done</button>
  ...
  <script>
    ...
    function addProjectCard() {
      ...
      card.innerHTML = `
        ...
        <div>
          ...
          <input class="ar-input ar-proj-name" type="text" placeholder="e.g. Practical Software Engineering" autocomplete="off" />
        </div>
        <div>
          <span class="ar-project-sublabel">Project URL</span>
          <input class="ar-input ar-proj-url" type="url" placeholder="https://drive.google.com/..." autocomplete="off" />
      ...
      // Auto-add new card when both fields of this card are filled
    ...
    // ── Submit ──
    document.getElementById('ar-done-btn').addEventListener('click', () => {
      let valid = true;
      ...
      const major = document.querySelector('input[name="ar-major"]:checked');
      if (!major) {
      ...
      // Validate all project URL fields that have a value
